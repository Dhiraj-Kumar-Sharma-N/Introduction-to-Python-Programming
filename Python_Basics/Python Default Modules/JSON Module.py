...
CLASSES
    ...
    class JSONDecoder(builtins.object)
     ...
     |      including ``'\t'`` (tab), ``'\n'``, ``'\r'`` and ``'\0'``.
     |  
     |  decode(self, s, _w=<built-in method match of re.Pattern object at 0x0000021405F7DDB0>)
...
Req_file = "C:\\Users\\dsharman\\Python_Workspace\\Python_Basics\\Other Files\\SampleJSON.json"
fo = open(Req_file, 'r')
json_object = json.load(fo)
print(json_object["book"])
print(json_object["book"][0]["author"])
fo.close()

# [{'id': '444', 'language': 'C', 'edition': 'First', 'author': 'Dennis Ritchie '}, {'id': '555', 'language': 'C++', 'edition': 'second', 'author': ' Bjarne Stroustrup '}]
# Dennis Ritchie

# ================================  READ JSON ==================================================
My_Dic = {'FName': 'Dhiraj Kumar', 'LName': 'Sharma N', 'Age': 27,
          'SkillSet': ['Java', 'Python', 'JavaScript', 'Groovy']}
Req_file = "C:\\Users\\dsharman\\Python_Workspace\\Python_Basics\\Other Files\\CreatedJSON.json"
fo = open(Req_file, 'w')
