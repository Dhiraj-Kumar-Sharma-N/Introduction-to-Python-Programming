...
# ===============================  READ : USING CSV for Different delimiter ===================================

File_Path = 'C:\\Users\\dsharman\\Python_Workspace\\Python_Basics\\Other Files\\SampleCsvFile_withDelim.csv'
FileObject = open(File_Path, 'r')
CSVObj = csv.reader(FileObject, lineterminator='\n', delimiter=",")
for each_r in CSVObj:
    print(each_r)
FileObject.close()
...
# ===============================  WRITE : USING CSV for Different delimiter ===================================

Complete_data = [['Sl.no', 'Book Name', 'Author'], ['1', 'Java Basics', 'James Gosling'],
                 ['2', 'Python Pro', 'Ben Cutting']]

File_Path = 'C:\\Users\\dsharman\\Python_Workspace\\Python_Basics\\Other Files\\CreatedCsvFile_withDelim.csv'
FileObject = open(File_Path, 'w', newline="")
CSVObj = csv.writer(FileObject, delimiter=",")
CSVObj.writerows(Complete_data)
FileObject.close()
